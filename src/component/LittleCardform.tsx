const LittleCardform = () => {
  return (
      <>
          <h1 className="text-2xl font-bold text-blue-400 text-center mb-6" style={{ marginTop: '50px', marginBottom: '50px' }}>Little Card Form</h1>
              ...
              <form className="space-y-8 p-8 md:max-w-6xl sm:max-w-screen-sm w-full mx-4 sm:my-16 sm:mx-10 md:mx-8 lg:mx-16 xl:mx-24">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2  xl:grid-cols-4 gap-6">
                      ...
                      <div className="bg-white p-6 rounded-lg shadow-lg">
                          <label className="block text-lg font-semibold mb-2" htmlFor="littlefile">
                              Upload Image
                          </label>
                          <input
                              type="file"
